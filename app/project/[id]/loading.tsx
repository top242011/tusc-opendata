        ...
        <div className="min-h-screen bg-[rgb(var(--ios-bg-grouped))]">
            ...
            <div className="py-8 px-4">
                <div className="max-w-4xl mx-auto animate-pulse">
                    ...
                    {/* Header Card — matches ios design tokens + completeness score */}
                    <div className="bg-[rgb(var(--ios-bg-secondary))] px-8 py-8 shadow-[var(--ios-shadow-sm)] border rounded-[var(--ios-radius-lg)] mb-6 relative overflow-hidden">
                        {/* Completeness Score bar (new in origin/main) */}
